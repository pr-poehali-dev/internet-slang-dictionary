      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-r from-primary/90 to-secondary/90 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90 animate-fade-in" style={{animationDelay: '0.1s'}}>
              Расшифровываем специфические термины из разных профессиональных сфер
            </p>
            
            <div className="max-w-2xl mx-auto relative" style={{animationDelay: '0.2s'}}>
              <Input 
                type="text"
            ...
            <TabsContent value="popular" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredTerms.map((term, index) => (
                  <div key={term.id} className="animate-fade-in" style={{animationDelay: `${index * 0.1}s`}}>
                    <TermCard term={term} />
                  </div>
                ))}
              </div>
        ...
        <section className="bg-gray-100 py-14">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Знаете профессиональный сленг?</h2>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Делитесь своими знаниями и помогайте другим разобраться в терминологии вашей профессиональной сферы.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="text-xl font-semibold text-white">ПрофСленг</span>
            </div>
